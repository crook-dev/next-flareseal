...
export default function RefundPolicy() {
  ...
  <p>
    ...
    <a className="text-info" href="mailto:support@flareseal.com"
      >support@flareseal.com</a
  ...
  <h2 className="text-primary text-2xl">Damages and issues</h2>
  <p>
  ...
  <h2 className="text-primary text-2xl">Exceptions / non-returnable items</h2>
  <p>
  ...
  <h2 className="text-primary text-2xl">Exchanges</h2>
  <p>
  ...
  <h2 className="text-primary text-2xl">Refunds</h2>
  <p>
