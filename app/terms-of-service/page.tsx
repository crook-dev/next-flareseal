...
export const metadata: Metadata = {
  title: 'Terms of Service | FlareSeal',
  description: 'Read the terms and conditions that govern your use of FlareSeal\'s website and services.',
  alternates: {
    canonical: 'https://www.flareseal.com/terms-of-service',
  },
};
    ...
    <>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: 'Read the terms and conditions that govern your use of FlareSeal\'s website and services.',
            url: 'https://www.flareseal.com/terms-of-service',
            breadcrumb: {
              '@type': 'BreadcrumbList',
              itemListElement: [
                {
                ...
                },
                {
                  ...
                  position: 2,
                  name: 'Terms of Service',
                  item: 'https://www.flareseal.com/terms-of-service'
                }
              ]
            }
          }).replace(/</g, '\\u003c'),
      ...
      <main>
        <div className="container py-8">
          <h1 className="text-center mb-8 text-primary">Terms Of Service</h1>
          <h2 className="text-primary uppercase text-2xl">OVERVIEW</h2>
          <p>
            This website is operated by FlareSeal. Throughout the site, the terms
            &quot;we&quot;, &quot;us&quot; and &quot;our&quot; refer to FlareSeal. FlareSeal offers this website,
          ...
          <h2 className="text-primary uppercase text-2xl">
          ...
          <p>
            ...
            information for all purchases made at ur store. You agree to promptly
          ...
          <p>
            ...
            <a className="text-info" href="/refund-policy/">Returns Policy</a>.
          </p>
          ...
          <p>
            ...
            <a className="text-info" href="/privacy-policy/">Privacy Policy</a>.
          </p>
          ...
          <p>
            ...
            shall FlareSeal, our directors, officers, employees, affiliates, agents,
          ...
          <p>
            You agree to indemnify, defend and hold harmless FlareSeal and our
          ...
          <h2 className="text-primary uppercase text-2xl">SECTION 15 - SEVERABILITY</h2>
          <p>
          ...
          <h2 className="text-primary uppercase text-2xl">SECTION 16 - TERMINATION</h2>
          <p>
          ...
          <p>
            ...
            <a href="mailto:support@flareseal.com">support@flareseal.com</a>.
          </p>
        </div>
      </main>
    </>
